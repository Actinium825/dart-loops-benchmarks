...
class Character {
  ...
  factory Character.fromJson(Map<String, dynamic> json) {
    return Character(
      ...
      affiliations: (json['affiliations'] as List<dynamic>).map((e) => e.toString()).toList(),
      ...
      relatives: (json['relatives'] as List<dynamic>).map((e) => e.toString()).toList(),
      weapons: (json['weapons'] as List<dynamic>).map((e) => e.toString()).toList(),
